...
//全局请求头
var UserAgent []string = []string{"Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1; SV1; AcooBrowser; .NET CLR 1.1.4322; .NET CLR 2.0.50727)",
...
func Fetch(url string) (contents []byte, err error) {
	...
	utfReader := transform.NewReader(bodyReader, e.NewDecoder())
